...
const PakageSuccess = () => {
   ...
   useEffect(() => {
    setTimeout(() => {      
    ctx.sendCommand("Package Payment Success", { amount, user_id, payment_id, order_id, signature });
    }, 500);
   }, []);
        ...
        <View flex={1} bg="#007367" justifyContent="center" alignItems="center"  px={4}>
             ...
             <VStack space={4} alignItems="center">
                ...
                <Text fontSize="2xl" fontWeight="bold" color="white">
                    Package Subscription Successfully!
                </Text>
                ...
                <Button 
                    ...
                    onPress={() => navigation.navigate("gdiner/MessCard")}
                >
                    Check Subscription
                </Button>
            </VStack>
